...
from src.InpaintAnything.utils import load_img_to_array, save_array_to_img
    #, dilate_mask, show_mask, show_points, get_clicked_point
...
class InpaintModel:
    def __init__(self, input_img='./data/init_image/1.jpg',
                 ...
                 lama_ckpt='./src/InpaintAnything/pretrained_models/big-lama',
